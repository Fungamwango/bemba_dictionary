...
var subscription_modal = '<div style="position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.85);z-index:99999;display:flex;align-items:center;justify-content:center;font-family:Arial,sans-serif;overflow-y:auto;">'
  ...
  + '<p style="color:#444;font-size:14px;"> for just <b>'+PAYMENT_AMOUNT+'</b> for 4 days!</p>'
...
if(moreLinks){
  ...
  if(isSubscribed()){
    ...
    subItem.innerHTML = '<span>&#11088;</span> Get Unlimited access ('+PAYMENT_AMOUNT+' for 4 days)';
  ...
  if(currentUsage.words >= FREE_WORD_LIMIT){
    ...
    if(loadingEl){
      loadingEl.innerHTML = '<div style="text-align:center;padding:30px 15px;">'
        ...
        + '<button id="bemdic-limit-btn" style="padding:10px 22px;border:none;border-radius:8px;font-size:15px;cursor:pointer;background:#2e7d32;color:#fff;">Get Unlimited - '+PAYMENT_AMOUNT+' for 4 days</button>'
        + '</div>';
