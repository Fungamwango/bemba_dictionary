...
export async function onRequestPost(context) {
  ...
  var user = await db.prepare(
    'SELECT id, name, friend_code, points, total_quizzes, challenges_won, challenges_lost, challenges_drawn, picture, created_at, last_seen FROM users WHERE device_id = ?'
