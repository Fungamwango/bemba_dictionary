...
export async function onRequestPost(context) {
  var { device_id, receiver_id, sender_score, questions, message } = await context.request.json();
  ...
  ).bind(me.id, receiver_id, sender_score, questionsStr, challengeMsg).first();
